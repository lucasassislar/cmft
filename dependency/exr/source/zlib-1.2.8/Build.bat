...
set ABS_BUILDS_X64_PATH=
set ABS_BUILDS_X86PATH=
...
%VS% zlib.sln /build "Release|x64"
%VS% zlib.sln /build "Release|x64" /project INSTALL
exit
...
%VS% zlib.sln /build "Release|Win32"
%VS% zlib.sln /build "Release|Win32" /project INSTALL
exit