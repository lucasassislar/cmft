...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE STATIC_LIBRARY OPTIONAL FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/Debug/IlmImf-2_2.lib")
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE STATIC_LIBRARY OPTIONAL FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/Release/IlmImf-2_2.lib")
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE STATIC_LIBRARY OPTIONAL FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/MinSizeRel/IlmImf-2_2.lib")
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE STATIC_LIBRARY OPTIONAL FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/RelWithDebInfo/IlmImf-2_2.lib")
  endif()
endif()
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Dd][Ee][Bb][Uu][Gg])$")
    list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
     "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib/IlmImf-2_2.dll")
    if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
        message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
    endif()
    if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE SHARED_LIBRARY FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/Debug/IlmImf-2_2.dll")
  elseif("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Rr][Ee][Ll][Ee][Aa][Ss][Ee])$")
    list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
     "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib/IlmImf-2_2.dll")
    if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE SHARED_LIBRARY FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/Release/IlmImf-2_2.dll")
  elseif("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Mm][Ii][Nn][Ss][Ii][Zz][Ee][Rr][Ee][Ll])$")
    list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
     "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib/IlmImf-2_2.dll")
    if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE SHARED_LIBRARY FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/MinSizeRel/IlmImf-2_2.dll")
  elseif("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Rr][Ee][Ll][Ww][Ii][Tt][Hh][Dd][Ee][Bb][Ii][Nn][Ff][Oo])$")
    list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
     "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib/IlmImf-2_2.dll")
    if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "C:/Dev/cmftsharp/cmft/dependency/exr/builds/x86/lib" TYPE SHARED_LIBRARY FILES "C:/Dev/cmftsharp/cmft/dependency/exr/source/openexr-2.2.0/IlmImf/RelWithDebInfo/IlmImf-2_2.dll")
  endif()
endif()
